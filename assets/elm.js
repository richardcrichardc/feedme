...
var _user$project$Menu$footer = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Website by '),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$a,
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('feedme.nz'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Menu$aboutView = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ultricies euismod elit, a aliquam ex sodales ut.'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Nulla facilisi. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nullam auctor ac mauris ac pellentesque.'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Menu$locationView = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('container section'),
	...
	},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('map mx-auto d-block'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src('https://maps.googleapis.com/maps/api/staticmap?markers=foodtastic,Whanganui&zoom=17&size=300x300&style=feature:poi.business|visibility:off'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Majestic Square, Whanganui'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Menu$logoView = function (title) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('container logoBox d-flex flex-column justify-content-center'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('mx-auto d-block'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src('/assets/food.jpg'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
...
var _user$project$Menu$tdAlignRight = _rundis$elm_bootstrap$Bootstrap_Table$cellAttr(
	_elm_lang$html$Html_Attributes$class('text-right'));
var _user$project$Menu$priceString = function (price) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'$',
		A2(_cuducos$elm_format_number$FormatNumber$format, _cuducos$elm_format_number$FormatNumber_Locales$usLocale, price));
};
var _user$project$Menu$invoiceLineView = function (line) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Table$tr,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(line.qty)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(line.desc),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Menu$tdAlignRight,
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_user$project$Menu$priceString(line.total)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Menu$invoiceTotalLine = function (total) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Table$tr,
		{ctor: '[]'},
		{
				...
				_1: {
					...
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_user$project$Menu$priceString(total)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Menu$itemQty = F2(
	function (id, order) {
		itemQty:
		while (true) {
			var _p0 = order;
			if (_p0.ctor === '[]') {
				...
				var _p1 = _p0._0;
				if (_elm_lang$core$Native_Utils.eq(_p1.id, id)) {
					return _p1.qty;
				} else {
					var _v1 = id,
						_v2 = _p0._1;
...
var _user$project$Menu$orderAdd = F2(
	function (item, order) {
		var _p2 = order;
		if (_p2.ctor === '[]') {
			return {
			...
			var _p4 = _p2._1;
			var _p3 = _p2._0;
			return _elm_lang$core$Native_Utils.eq(_p3.id, item.id) ? {
				ctor: '::',
				_0: {id: _p3.id, qty: _p3.qty + item.qty},
				_1: _p4
			} : {
				ctor: '::',
				_0: _p3,
				_1: A2(_user$project$Menu$orderAdd, item, _p4)
			};
		}
	});
var _user$project$Menu$Menu = F2(
	function (a, b) {
		return {title: a, items: b};
	});
var _user$project$Menu$MenuItem = F4(
	function (a, b, c, d) {
		return {id: a, name: b, desc: c, price: d};
	});
var _user$project$Menu$itemDecoder = A5(
...
var _user$project$Menu$menuDecoder = A3(
	...
	A2(
		...
		'items',
		_elm_lang$core$Json_Decode$list(_user$project$Menu$itemDecoder)));
var _user$project$Menu$decode = function (str) {
	return A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Menu$menuDecoder, str);
};
var _user$project$Menu$menuItemForId = F2(
	function (items, id) {
		menuItemForId:
		while (true) {
			var _p5 = items;
			if (_p5.ctor === '[]') {
				return A4(_user$project$Menu$MenuItem, -1, 'Error', 'Error', -1.0);
			} else {
				var _p6 = _p5._0;
				if (_elm_lang$core$Native_Utils.eq(_p6.id, id)) {
					return _p6;
				} else {
					var _v5 = _p5._1,
						_v6 = id;
					items = _v5;
					id = _v6;
					continue menuItemForId;
				}
			}
		}
	});
var _user$project$Menu$orderItemInvoiceLine = F2(
	function (menu, orderItem) {
		var menuItem = A2(_user$project$Menu$menuItemForId, menu.items, orderItem.id);
		return {
			qty: orderItem.qty,
			desc: menuItem.name,
			each: menuItem.price,
			total: _elm_lang$core$Basics$toFloat(orderItem.qty) * menuItem.price
		};
	});
var _user$project$Menu$orderInvoice = F2(
	function (menu, order) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Menu$orderItemInvoiceLine(menu),
			order);
	});
var _user$project$Menu$invoiceView = F2(
	function (menu, order) {
		var invoice = A2(_user$project$Menu$orderInvoice, menu, order);
		...
		var lines = A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$map, _user$project$Menu$invoiceLineView, invoice),
			{
				ctor: '::',
				_0: _user$project$Menu$invoiceTotalLine(total),
				_1: {ctor: '[]'}
			});
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Table$simpleThead(
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Qty'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$Menu$OrderItem = F2(
	function (a, b) {
		return {id: a, qty: b};
	});
var _user$project$Menu$InvoiceLine = F4(
	function (a, b, c, d) {
		return {qty: a, desc: b, each: c, total: d};
	});
var _user$project$Menu$Add = function (a) {
	return {ctor: 'Add', _0: a};
};
var _user$project$Menu$itemView = F2(
	function (order, item) {
		var qty = A2(_user$project$Menu$itemQty, item.id, order);
		var qtyHtml = (_elm_lang$core$Native_Utils.cmp(qty, 0) > 0) ? A2(
			...
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(qty),
						' in order ')),
				_1: {ctor: '[]'}
			}) : _elm_lang$html$Html$text('');
		var heading = _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: item.name,
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$Menu$priceString(item.price),
						_1: {ctor: '[]'}
					}
				}
			});
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(item.desc),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$Menu$menuView = F2(
	function (menu, order) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Menu$itemView(order),
						menu.items)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Menu$singlePageView = F2(
	function (menu, order) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _user$project$Menu$logoView(menu.title),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('container menu section'),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Menu$menuView, menu, order),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						ctor: '::',
						_0: _user$project$Menu$locationView,
						_1: {
							ctor: '::',
							_0: _user$project$Menu$aboutView,
							_1: {
								ctor: '::',
								_0: _user$project$Menu$footer,
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Menu$maybeSinglePageView = F2(
	function (menu_, order) {
		var _p7 = menu_;
		if (_p7.ctor === 'Just') {
			return A2(_user$project$Menu$singlePageView, _p7._0, order);
		} else {
			return _elm_lang$html$Html$text('No menu');
		}
	});
var _user$project$Menu$maybeMenuView = F2(
	function (menu_, order) {
		var _p8 = menu_;
		if (_p8.ctor === 'Just') {
			return A2(_user$project$Menu$menuView, _p8._0, order);
		} else {
			return _elm_lang$html$Html$text('No menu');
		}
	});

var _user$project$Rails$httpErrorToString = function (err) {
	var _p0 = err;
	switch (_p0.ctor) {
		case 'BadUrl':
			return A2(
		...
		case 'BadStatus':
			var _p2 = _p0._0;
			if (_elm_lang$core$Native_Utils.eq(_p2.status.code, 422)) {
				var _p1 = A2(
		...
		default:
			return A2(_elm_lang$core$Basics_ops['++'], 'BadPayload: ', _p0._0);
	}
};
var _user$project$Rails$FormTarget = F3(
	function (a, b, c) {
		return {method: a, url: b, auth_token: c};
	});
var _user$project$Rails$FormFlags = F2(
	function (a, b) {
		return {target: a, fields: b};
	});
var _user$project$Rails$FormRedirect = function (a) {
	return {ctor: 'FormRedirect', _0: a};
};
var _user$project$Rails$FormError = function (a) {
	return {ctor: 'FormError', _0: a};
};
var _user$project$Rails$responseCmd = function (resp) {
	var _p3 = resp;
	if (_p3.ctor === 'Ok') {
		return _user$project$Rails$FormRedirect(_p3._0);
	} else {
		return _user$project$Rails$FormError(
			_user$project$Rails$httpErrorToString(_p3._0));
	}
};
var _user$project$Rails$submitForm = F3(
	function (target, name, value) {
		var decoder = A2(_elm_lang$core$Json_Decode$field, 'redirect', _elm_lang$core$Json_Decode$string);
		var encoder = _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'authenticity_token',
						_1: _elm_lang$core$Json_Encode$string(target.auth_token)
					},
					_1: {ctor: '[]'}
				}
			});
		...
		return A2(_elm_lang$http$Http$send, _user$project$Rails$responseCmd, request);
	});

var _user$project$PlaceOrder$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'NewLocation') {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						order: A2(_user$project$Menu$orderAdd, _p0._0._0, model.order)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$PlaceOrder$scrollIntoView = _elm_lang$core$Native_Platform.outgoingPort(
	'scrollIntoView',
	function (v) {
		return v;
	});
var _user$project$PlaceOrder$scrollHash = function (location) {
	return _elm_lang$core$Native_Utils.eq(location.hash, '') ? _elm_lang$core$Platform_Cmd$none : _user$project$PlaceOrder$scrollIntoView(
		A2(_elm_lang$core$String$dropLeft, 1, location.hash));
};
var _user$project$PlaceOrder$init = F2(
	function (flags, location) {
		return {
			...
			_0: {
				...
				menu: _elm_lang$core$Maybe$Just(flags.fields.menu),
				order: {ctor: '[]'}
			},
			_1: _user$project$PlaceOrder$scrollHash(location)
		};
	});
var _user$project$PlaceOrder$Model = F4(
	function (a, b, c, d) {
		return {target: a, menu_id: b, menu: c, order: d};
	});
var _user$project$PlaceOrder$FlagFields = F2(
	function (a, b) {
		return {menu_id: a, menu: b};
	});
var _user$project$PlaceOrder$MenuMsg = function (a) {
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						_user$project$PlaceOrder$MenuMsg,
						A2(_user$project$Menu$maybeSinglePageView, model.menu, model.order)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$PlaceOrder$NewLocation = function (a) {
	return {ctor: 'NewLocation', _0: a};
};
var _user$project$PlaceOrder$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_user$project$PlaceOrder$NewLocation,
	{
		init: _user$project$PlaceOrder$init,
		view: _user$project$PlaceOrder$view,
		update: _user$project$PlaceOrder$update,
							...
							return A2(
								...
								function (method) {
									return A2(
										...
										function (url) {
											return _elm_lang$core$Json_Decode$succeed(
												{auth_token: auth_token, method: method, url: url});
										},
										A2(_elm_lang$core$Json_Decode$field, 'url', _elm_lang$core$Json_Decode$string));
								},
								A2(_elm_lang$core$Json_Decode$field, 'method', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'auth_token', _elm_lang$core$Json_Decode$string))));
		},
		A2(
			_elm_lang$core$Json_Decode$field,
			'fields',
			A2(
				...
				function (menu) {
					return A2(
						...
						A2(_elm_lang$core$Json_Decode$field, 'menu_id', _elm_lang$core$Json_Decode$int));
				},
				A2(
					_elm_lang$core$Json_Decode$field,
					'menu',
												...
												return A2(
													...
													function (name) {
														return A2(
															...
															function (price) {
																return _elm_lang$core$Json_Decode$succeed(
																	{desc: desc, id: id, name: name, price: price});
															},
															A2(_elm_lang$core$Json_Decode$field, 'price', _elm_lang$core$Json_Decode$float));
													},
													A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
